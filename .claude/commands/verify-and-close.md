---
description: Verify a task is truly done with concrete proof before closing it out.
---

Verify the current task is complete with concrete evidence before closing.
...
6. Update `tasks/lessons.md` if any corrections were made during this task
...
- [ ] Lessons captured in `tasks/lessons.md` (if applicable)
